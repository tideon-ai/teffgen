"""
Persistent conversation sessions for tideon.ai.

A Session stores a conversation history (and optional memory snapshot)
in ~/.teffgen/sessions/<session_id>.json so it can be reloaded by any
...
DEFAULT_SESSION_DIR = os.path.expanduser("~/.teffgen/sessions")
...
class SessionManager:
    """
    Filesystem-backed session store living in ~/.teffgen/sessions/.
