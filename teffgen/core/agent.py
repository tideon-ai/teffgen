"""
Core Agent implementation for tideon.ai.
...
{scratchpad}"""
    ...
    def __init__(self, config: AgentConfig, session_id: str | None = None):
        ...
        Args:
            ...
            session_id: Optional persistent session id. If provided, the
                agent loads/creates a Session in ~/.teffgen/sessions/ and
    ...
    def run(self,
        ...
        with trace_agent_run(self.name, task, run_id=run_id) as _span, \
            ...
            try:
                ...
                set_span_attribute("teffgen.tokens_used", response.tokens_used)
                set_span_attribute("teffgen.tool_calls", response.tool_calls)
                set_span_attribute("teffgen.success", response.success)
                set_span_attribute("teffgen.latency", response.execution_time)
    ...
    def run_batch(
        ...
        **run_kwargs: Any,
        ...
        Convenience wrapper around :class:`~teffgen.core.batch.BatchRunner`.
