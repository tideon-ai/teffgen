...
OpenAI-compatible client) can be pointed at an tideon.ai server unchanged.
"""
...
def resolve_model_alias(model: str) -> str:
    """Resolve an OpenAI model name to a local tideon.ai model id."""
...
def _messages_to_prompt(messages: list[Any]) -> str:
    ...
    Used as a fallback path when an tideon.ai agent is invoked directly rather
