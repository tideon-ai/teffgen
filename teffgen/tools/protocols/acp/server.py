"""
ACP server implementation for exposing tideon.ai via ACP protocol.

This module provides server functionality to expose tideon.ai capabilities
...
class ACPServer:
    """
    ACP server for exposing tideon.ai capabilities.
