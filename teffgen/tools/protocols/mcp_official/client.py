...
class TeffgenMCPClient:
    """
    Official MCP client implementation for tideon.ai.
    ...
    Example:
        ```python
        from teffgen.tools.protocols.mcp_official import TeffgenMCPClient, MCPServerConfig
...
def create_client(config: MCPServerConfig) -> TeffgenMCPClient:
    """
    ...
    Returns:
        MCP client instance
    """
    return TeffgenMCPClient(config)
