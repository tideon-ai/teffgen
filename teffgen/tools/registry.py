"""
Tool registry for the tideon.ai framework.
...
class ToolRegistry:
    """
    Central registry for managing tools in the tideon.ai framework.
    ...
    def discover_builtin_tools(self) -> None:
        ...
        Scans the teffgen.tools.builtin package for tool classes.
        """
        try:
            from . import builtin
            ...
            for file_path in builtin_path.glob("*.py"):
                ...
                module_name = f"teffgen.tools.builtin.{file_path.stem}"
                try:
