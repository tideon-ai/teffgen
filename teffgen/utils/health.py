"""
Health monitoring and infrastructure checking for tideon.ai.

Provides health checks for:
- Website availability (tideon.ai, docs.tideon.ai)
- DNS resolution
...
class HealthChecker:
    """
    Infrastructure health checker for tideon.ai.
    ...
    DEFAULT_URLS = [
        "https://tideon.ai",
        "https://docs.tideon.ai",
    ]
    PYPI_URL = "https://pypi.org/pypi/teffgen/json"
    TIMEOUT = 10
    ...
    def check_all(self) -> list[HealthCheckResult]:
        ...
        # DNS check
        results.append(self.check_dns("tideon.ai"))

        # SSL check
        results.append(self.check_ssl("tideon.ai"))
    ...
    def check_pypi(self, package: str = "teffgen") -> HealthCheckResult:
