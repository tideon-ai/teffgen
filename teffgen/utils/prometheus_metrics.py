"""
Prometheus-compatible metrics collection for tideon.ai.
...
Usage:
    from teffgen.utils.prometheus_metrics import metrics
...
class TeffgenMetrics:
    """
    Collection of all tideon.ai metrics.

    Metrics follow the naming convention: teffgen_<subsystem>_<metric>_<unit>
    Labels: agent_name, model_name, tool_name
    """
    ...
    def __init__(self):
        ...
        self.total_requests = Counter(
            "teffgen_requests_total",
            "Total number of agent run requests",
        )
        self.tool_calls = Counter(
            "teffgen_tool_calls_total",
            "Total number of tool calls",
        )
        self.tool_failures = Counter(
            "teffgen_tool_failures_total",
            "Total number of failed tool calls",
        )
        self.errors = Counter(
            "teffgen_errors_total",
            "Total number of errors",
        )
        self.fallbacks = Counter(
            "teffgen_fallbacks_total",
            "Total number of fallback invocations",
        )
        self.circuit_breaker_trips = Counter(
            "teffgen_circuit_breaker_trips_total",
            "Total number of circuit breaker trips",
        )
        self.tokens_used = Counter(
            "teffgen_tokens_used_total",
            "Total tokens consumed",
        )

        # --- Histograms ---
        self.response_latency = Histogram(
            "teffgen_response_latency_seconds",
        ...
        self.tool_execution_time = Histogram(
            "teffgen_tool_execution_seconds",
        ...
        self.active_agents = Gauge(
            "teffgen_active_agents",
            "Number of currently active agents",
        )
        self.gpu_memory_used = Gauge(
            "teffgen_gpu_memory_used_bytes",
