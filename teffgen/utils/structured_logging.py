"""
Structured logging for tideon.ai framework.
...
Usage:
    from teffgen.utils.structured_logging import StructuredLogger, get_structured_logger
    ...
    from teffgen.utils.structured_logging import LogRunContext
...
class TeffgenJSONFormatter(logging.Formatter):
    """
    JSON formatter that automatically injects tideon.ai context fields
...
# ---------------------------------------------------------------------------
# StructuredLogger — high-level API for tideon.ai events
# ---------------------------------------------------------------------------

class StructuredLogger:
    """
    High-level structured logger for tideon.ai components.
...
def setup_json_logging(
    ...
    handler.setFormatter(TeffgenJSONFormatter())
