"""
Debug inspector for tideon.ai agents.
...
class DebugAgent:
    """
    Thin wrapper around :class:`teffgen.core.agent.Agent` that captures a
...
def run_debug_cli(
    ...
    console.print(Panel(f"[bold]tideon.ai Debug Mode[/bold]\nTask: {task}", style="blue"))
