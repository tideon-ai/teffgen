...
from teffgen.rag.search import SearchResult
...
class LLMReranker(Reranker):
    ...
    scale. Works with any teffgen BaseModel that supports `generate`.
    """
    ...
    def _generate(self, prompt: str) -> str:
        ...
        # 1) Try teffgen BaseModel-style: generate(prompt, config=GenerationConfig)
        try:
            from teffgen.models.base import GenerationConfig  # type: ignore
