"""
teffgen.rag — Advanced Retrieval-Augmented Generation pipeline.

Provides a production-grade RAG pipeline built on top of the existing
`teffgen.tools.builtin.retrieval` primitives:
...
from teffgen.rag.attribution import Citation, CitationTracker
...
from teffgen.rag.context_builder import ContextBuilder
from teffgen.rag.ingest import DocumentIngester, IngestedChunk
from teffgen.rag.reranker import (
    CrossEncoderReranker,
    LLMReranker,
    RuleBasedReranker,
)
from teffgen.rag.search import HybridSearchEngine, SearchResult
